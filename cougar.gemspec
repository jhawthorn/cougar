...
require_relative "lib/cougar/version"

Gem::Specification.new do |spec|
  spec.name = "cougar"
  spec.version = Cougar::VERSION
  spec.authors = ["John Hawthorn"]
  spec.email = ["john@hawthorn.email"]

  spec.summary = "A fast, Ractor-first web server for Ruby"
  ...
  spec.metadata["changelog_uri"] = "https://github.com/jhawthorn/cougar/blob/main/CHANGELOG.md"
